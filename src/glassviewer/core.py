...
from glassviewer.formats.ase import convert_snap
import glassviewer.routines as routines
import os
import numpy as np
import warnings
import glassviewer.csystem as pc
from glassviewer.catom import Atom
import itertools
from ase.io import write
import uuid
import gzip
import io
import glassviewer.visualization as pv
...
class System(pc.System):
    ...
    atoms : list of :class:`~glassviewer.catom.Atom` objects
    ...
    .. note::
        ...
        atoms can be accessed or set as :attr:`~glassviewer.core.System.atoms`. However, due to
        technical reasons individual atoms should be accessed using the
        :func:`~glassviewer.core.System.get_atom` method. An atom can be assigned
        to the atom using the :func:`~glassviewer.core.System.set_atom` method.
    ...
    def read_inputfile(self, filename, format="lammps-dump", compressed = False, customkeys=None):
        ...
        :func:`~glassviewer.traj_process` module to process a file which is then assigned to system.
    ...
    def get_atom(self, index):
        ...
        Get the :class:`~glassviewer.catom.Atom` object at the queried position in the list of all atoms
        in the :class:`~glassviewer.core.System`.
    ...
    def set_atom(self, atom):
        ...
        Notes
        -----
        For example, an :class:`~glassviewer.catom.Atom` at location `i` in the list of all atoms in
        :class:`~glassviewer.core.System` can be queried by,
        ...
        :func:`~glassviewer.core.System.set_atom`.
    ...
    def calculate_pdf(self, histobins=100, histomin=0.0, cut=10, partial=False, centertype=1, secondtype=2,threadnum=10):
        ...
        hist=np.array(hist,dtype='int64')
    ...
    def find_neighbors(self, method='cutoff', cutoff=None, threshold=2, filter=None,
        ...
        Find neighbors of all atoms in the :class:`~glassviewer.core.System`.
        ...
        the methods can be `found here <https://glassviewer.readthedocs.io/en/latest/nearestneighbormethods.html>`_.
        ...
        In order to reduce time during the distance sorting during the adaptive methods, glassviewer sets an initial guess for a cutoff distance.
    ...
    def calculate_q(self, q, averaged = False, only_averaged=False, condition=None, clear_condition=False,atomlist=[]):
        ...
        :func:`~glassviewer.core.System.find_neighbors` for more details. If the keyword `average` is set to True,
        ...
        :func:`~glassviewer.core.System.cluster_atoms` for more details. If the
        `condition` is equal for both host atom and the neighbor, the neighbor is considered for
        calculation of q parameters. This is slightly different from :func:`~glassviewer.core.System.cluster_atoms`
    ...
    def find_solids(self, bonds=0.5, threshold=0.5, avgthreshold=0.6, 
        ...
        Check :func:`~glassviewer.core.System.find_neighbors` method.
        ...
        If `cluster` is True, a clustering is done for all solid particles. See :func:`~glassviewer.csystem.find_clusters`
        for more details. 
    ...
    def calculate_solidneighbors(self):
        ...
        Notes
        -----
        A solid bond is considered between two atoms if the `connection <https://glassviewer.readthedocs.io/en/latest/solidliquid.html>`_
    ...
    def find_largestcluster(self):
        ...
        Notes
        -----
        :func:`glassviewer.core.System.find_clusters` has to be used before using this function.
    ...
    def calculate_angularcriteria(self):
        ...
        The calculated A parameter for each atom is stored in :attr:`~glassviewer.catom.Atom.angular`.
    ...
    def calculate_chiparams(self, angles=False):
        ...
        chi params can be accessed using :attr:`~glassviewer.catom.chiparams`.
    ...
    def calculate_cna(self, lattice_constant=None):
        ...
        The assigned structures can be accessed by :attr:`~glassviewer.catom.Atom.structure`.
    ...
    def calculate_centrosymmetry(self, nmax=12, get_vals=True):
        ...
        :attr:`~glassviewer.catom.centrosymmetry` attribute. It calculates the degree of inversion
        symmetry of an atomic environment. Centrosymmetry recalculates the neighbor using
        the number method as specified in :func:`¬glassviewer.core.System.find_neighbors` method. This
    ...
    def calculate_disorder(self, averaged=False, q=6):
        ...
        can be accessed using :attr:`~glassviewer.catom.disorder` and the averaged version can be accessed using
        :attr:`~glassviewer.catom.avg_disorder`. For ordered systems, the value of disorder would be zero which would increase
    ...
    def calculate_sro(self, reference_type=1, average=True, shells=2):
        ...
        this to be possible, neighbors have to be found first using the :func:`~glassviewer.core.System.find_neighbors`
        ...
        shell. In order to estimate this cutoff, one can use the :func:`~glassviewer.core.System.calculate_pdf`
        method.
    ...
    def calculate_entropy(self, rm, sigma=0.2, rstart=0.001, h=0.001, local=False,
        ...
        Notes
        -----
        The entropy parameters can be accessed by :attr:`~glassviewer.catom.entropy`
        and :attr:`~glassviewer.catom.avg_entropy`. For a complete description of the entropy
        parameter, see `the documentation <http://glassviewer.com/en/latest/methods/entropy_parameters/entropy_parameters.html>`_
    ...
    def calculate_energy(self, species='Au', pair_style=None, 
        ...
        Values can be accessed through :attr:`glassviewer.catom.Atom.energy`
        Averaged values can be accessed through :attr:`glassviewer.catom.Atom.avg_energy`
