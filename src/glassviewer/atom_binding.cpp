...
py::class_<Atom>(m,"Atom", R"mydelimiter(
        ...
        the documentation of :class:`~glassviewer.core.System` class.

        Although an `Atom` object can be created independently, `Atom` should be thought of
        inherently as members of the :class:`~glassviewer.core.System` class. All the properties that define an atom are
        relative to the parent class. :class:`~glassviewer.core.System` has a list of all atoms. All the properties of an
        atom, hence should be calculated through :class:`~glassviewer.core.System`.
        ...
        References
        ----------
        `Creation of atoms <https://glassviewer.readthedocs.io/en/latest/examples.html>`_.
    ...
    .def_readwrite("condition", &Atom::condition, R"mydelimiter(
        *int*.
        ...
        :func:`~glassviewer.core.System.cluster_atoms`.
    )mydelimiter")
    ...
    .def_readwrite("custom", &Atom::custom, R"mydelimiter(
        *dict*.
        ...
        using `atom.custom = {"velocity":12}`. :func:`~glassviewer.core.System.read_inputfile` can also
    ...
    .def_readonly("coordination", &Atom::n_neighbors, R"mydelimiter(
        *int*.
        ...
        after neighbors are calculated using :func:`~glassviewer.core.System.find_neighbors`.
    )mydelimiter")
    ...
    .def_property("neighbor_weights",&Atom::gneighborweights, &Atom::sneighborweights, R"mydelimiter(
        *List of floats*.
        ...
        if :func:`~glassviewer.core.System.find_neighbors` is used with `method='voronoi'`,
   ...
   .def_readwrite("next_neighbor_distances", &Atom::next_neighbor_distances, R"mydelimiter(
    ...
    .def("get_q", (double (Atom::*) (int q, bool))  &Atom::gq_big,  py::arg(), py::arg("averaged")=false, R"mydelimiter(
          ...
          Notes
          -----
          Please check this `link <https://glassviewer.readthedocs.io/en/latest/steinhardtparameters.html>`_
          for more details about Steinhardts parameters and the averaged versions.

          Meaningful values are only returned if :func:`~glassviewer.core.System.calculate_q` is used.
    )mydelimiter")
    ...
    .def_readwrite("solid", &Atom::issolid, R"mydelimiter(
        *bool*.
        ...
        after using the :func:`~glassviewer.core.System.find_solids` function.
    )mydelimiter")
    ...
    .def_readwrite("largest_cluster", &Atom::lcluster, R"mydelimiter(
        *bool*.
        ...
        after using the :func:`~glassviewer.core.System.cluster_atoms` function.
    )mydelimiter")
    ...
    .def_readwrite("volume", &Atom::volume, R"mydelimiter(
        *float*. Voronoi volume of the atom. The Voronoi volume is only calculated if neighbors
        are found using the :func:`~glassviewer.core.System.find_neighbors` using the `method='voronoi'`
        option.
    )mydelimiter")
    ...
    .def_readwrite("avg_volume", &Atom::avgvolume, R"mydelimiter(
        *float*. Averaged version of the Voronoi volume which is calculated as an average over
        itself and its neighbors. Only calculated when the :func:`~glassviewer.core.System.find_neighbors`
    ...
    .def_property("face_vertices", &Atom::gfacevertices, &Atom::sfacevertices, R"mydelimiter(
          *list of floats*. A list of the number of vertices shared between an atom and its
          neighbors.  Only calculated when the :func:`~glassviewer.core.System.find_neighbors`
          using the `method='voronoi'` option is used.
    )mydelimiter")
    ...
    .def_property("face_perimeters", &Atom::gfaceperimeters, &Atom::sfaceperimeters, R"mydelimiter(
          *list of floats*. List consisting of the perimeters of each Voronoi face of an atom.
          Only calculated when the :func:`~glassviewer.core.System.find_neighbors`
          using the `method='voronoi'` option is used.
    )mydelimiter")
    ...
    .def_readwrite("vertex_numbers", &Atom::vertex_numbers, R"mydelimiter(
          *list of floats*. For each Voronoi face of the atom, this values includes a List
          of vertices that constitute the face.  Only calculated when the :func:`~glassviewer.core.System.find_neighbors`
          using the `method='voronoi'` option is used.
    )mydelimiter")
    ...
    .def_readwrite("vertex_vectors", &Atom::vertex_vectors, R"mydelimiter(
          *list of floats*. A list of positions of each vertex of the Voronoi polyhedra of
          the atom.  Only calculated when the :func:`~glassviewer.core.System.find_neighbors`
          using the `method='voronoi'` option is used.
    )mydelimiter")

    .def_property("vertex_positions", &Atom::gvertexpositions, &Atom::svertexpositions, R"mydelimiter(
          *list of list of floats*. Positions of Voronoi vertices.  Only calculated when the :func:`~glassviewer.core.System.find_neighbors`
          using the `method='voronoi'` option is used.
    )mydelimiter")
    ...
    .def_property("edge_lengths", &Atom::gedgelengths, &Atom::sedgelengths, R"mydelimiter(
          *list of floats*. For each face, this vector contains the lengths of edges
          that make up the Voronoi polyhedra of the atom.  Only calculated when the :func:`~glassviewer.core.System.find_neighbors`
          using the `method='voronoi'` option is used.
    )mydelimiter")
    ...
    .def_property("vorovector", &Atom::gvorovector, &Atom::svorovector, R"mydelimiter(
          *list of ints*. A vector of the form `(n3, n4, n5, n6)` where n3 is the number of faces with 3 vertices,
          ...
          Vorovector is calculated if the :func:`~glassviewer.core.System.calculate_vorovector` method is used.
    ...
    .def_readwrite("angular", &Atom::angular, R"mydelimiter(
        *Float*.
        ...
        Meaningful values are only returned if the property is calculated using :func:`~glassviewer.core.System.calculate_angularcriteria`.
    )mydelimiter")
    ...
    .def_readwrite("chiparams", &Atom::chiparams, R"mydelimiter(
        *Float*.
        ...
        Meaningful values are only returned if chi params are calculated using :func:`~glassviewer.core.System.calculate_chiparams`.
    )mydelimiter")
