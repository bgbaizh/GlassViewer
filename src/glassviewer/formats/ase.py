...
def convert_snap(sys, species=None):
    """
    Convert a given glassviewer structure to ase object
    ...
    exist in :attr:`~glassviewer.catom.Atom.custom`, this value is used for
    species. However if the value is not present, the keyword `species`
    is required. This should contain a mapping between :attr:`~glassviewer.catom.Atom.type`
